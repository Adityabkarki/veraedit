...
export function EffectKeyframeEditPanel() {
  ...
  if (!clip || !clip.effects) {
    return (
      <div className="flex flex-col h-full min-h-0 bg-bg-surface border-l border-bg-overlay">
        <RightPanelHeader title="Effect keyframes" testId="effect-keyframe-panel-close" />
        <p className="p-4 text-xs text-text-disabled">
          Select an effect clip on the Effects track to edit keyframes.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-bg-surface border-l border-bg-overlay overflow-hidden">
      <RightPanelHeader title={clip.label} testId="effect-keyframe-panel-close" />
